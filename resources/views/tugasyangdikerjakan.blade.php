...
<div class="row">
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <a href="{{ url('guru/tugasyangdikerjakan/cetak') }}" class="btn btn-warning btn-md"><i class='fa fa-print'> Cetak</i></a>
            <div class="x_content">
                <div class="row">
                    <div class="col-sm-12">
                            ...
                            <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->nilai < 1) Belum Dinilai @else {{ $item->nilai }}</td>
                                                @endif

                                        <td>
                                            <form action="{{ url('guru/tugasyangdikerjakan/nilai/' . $item->id) }}" method="POST">
                                                @csrf
                                                <input type="number" max="100" min="0" name="nilai" class="form-control" style="width: 80px; display: inline;" name="" id="" aria-describedby="helpId" placeholder="">
